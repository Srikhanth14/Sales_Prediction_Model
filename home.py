...
def home():
    ...
    st.write('''Curious about the mind behind the model? I'm SRIKHANTH R, a passionate data
    scientist dedicated to leveraging technology for insightful predictions.''')
    st.write("Feel free to reach out if you have questions, collaborations, or just want to chat about data science!")
